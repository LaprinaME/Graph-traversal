...
{
//Это простая реализация графа с использованием списка смежности 
//В данном случае, список смежности реализован в виде массива списков List<int>[] adj. 
//Каждый элемент массива представляет вершину, а список, который он хранит, содержит все вершины, смежные с этой вершиной.
